...
class Game {
  ...
  addStars() {
    const firstStar = new Star(100, 100, 65, 65);
    this.add(firstStar);
    return this.stars;
  }
 
  addEnemies() {
    const firstEnemy = new Enemy(600, 200, 50, 75);
    this.add(firstEnemy);
    return this.enemies;
  }
  ...
  checkCollision(object) {
    ...
    if ((object instanceof Cloud) && player.descending) {
      let cloud = object;
      ...
      this.clouds.forEach( (cloud, index) => {
        ...
        this.stars.forEach ((star, idx) => {
          ...
          if (star.y > this.height * 4) {
            this.stars[idx] = new Star(this.getRandomNum(400), this.getRandomNum(100), 65, 65);
          }
        });
        ...
        this.enemies.forEach ((enemy, idx) => {
          ...
          if (enemy.y > this.height * 3) {
            this.enemies[idx] = new Enemy(this.getRandomNum(400), this.getRandomNum(100), 50, 75);
          }
        });
