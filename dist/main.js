...
exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js")(true);
// Module
exports.push([module.i, "body {\n  background-image: url(\"http://www.jakpost.travel/imgfiles/full/31/315598/pastel-sky-wallpaper.jpg\");\n  background-size: cover;\n  font-family: 'Pontano Sans', sans-serif;\n  margin: 0 auto; }\n\n.game-container {\n  margin-left: 300px;\n  margin-top: 100px;\n  display: flex; }\n\n.instructions {\n  background-color: rgba(173, 216, 230, 0.7);\n  width: 600px;\n  height: 700px;\n  align-items: center;\n  text-align: center;\n  color: white; }\n  .instructions h3 {\n    font-family: \"Luckiest Guy\", cursive;\n    font-size: 45px;\n    letter-spacing: .07em;\n    background: -webkit-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: -o-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: -moz-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    -webkit-background-clip: text;\n    -webkit-text-fill-color: transparent;\n    margin-bottom: 0px;\n    position: relative; }\n  .instructions h3:after {\n    background: none;\n    content: attr(data-text);\n    left: 0;\n    position: absolute;\n    text-shadow: 3px 2px 10px rgba(0, 0, 0, 0.33);\n    top: 0;\n    z-index: -1; }\n  .instructions h4 {\n    font-family: \"Luckiest Guy\", cursive;\n    color: #e165e1;\n    font-size: 22px;\n    letter-spacing: 0.3em;\n    margin-bottom: 12px;\n    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2); }\n  .instructions p {\n    color: #966ff5;\n    font-size: 16px;\n    width: 90%;\n    margin: 0 auto; }\n  .instructions span {\n    color: #8369c2;\n    font-size: 18px;\n    font-weight: bold;\n    text-transform: uppercase;\n    font-family: \"Luckiest Guy\", cursive;\n    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2); }\n  .instructions img {\n    width: 30px;\n    margin-left: 10%;\n    margin-right: 10px; }\n  .instructions #white-cloud {\n    width: 40px;\n    height: 40px;\n    margin-left: 10%;\n    margin-right: 0px; }\n  .instructions ul {\n    list-style: none;\n    text-align: left; }\n    .instructions ul li {\n      color: #966ff5; }\n\n.arrows {\n  font-size: 30px;\n  display: inline-block;\n  margin: 0px 20px; }\n  .arrows .fab {\n    width: 40px;\n    height: 40px;\n    background-color: black;\n    color: blue; }\n\n#press-start {\n  color: white; }\n\n#canvas {\n  margin: 0 auto; }\n\n.canvas-container {\n  width: 1000px;\n  height: 700px;\n  margin: 0 auto; }\n  .canvas-container img {\n    display: none; }\n\n#start-btn {\n  font-size: 35px;\n  font-family: 'Luckiest Guy', sans-serif;\n  color: white;\n  letter-spacing: .07em;\n  padding-top: 10px;\n  text-transform: uppercase;\n  width: 150px;\n  height: 70px;\n  border-radius: 200px;\n  border: #e165e1;\n  background-color: #e165e1;\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); }\n\n#start-btn:hover {\n  background-color: white;\n  color: #e165e1;\n  transition: 0.2s;\n  cursor: pointer; }\n\n.hidden-div {\n  display: none; }\n\n.developer-icons {\n  margin-top: 30px; }\n  .developer-icons i {\n    font-size: 35px;\n    color: #9d7ced; }\n  .developer-icons i:hover {\n    color: #8c55d4;\n    transition: 0.3ms; }\n", "",{"version":3,"sources":["/Users/Kenneth/Desktop/cloud-jumper/src/styles/src/styles/appStyles.scss","/Users/Kenneth/Desktop/cloud-jumper/src/styles/src/styles/themeColors.scss"],"names":[],"mappings":"AAGA;EACE,oGAAmG;EACnG,uBAAsB;EACtB,wCAAuC;EACvC,eAAc,EACf;;AAED;EACE,mBAAkB;EAClB,kBAAiB;EACjB,cAAa,EACd;;AAED;EACE,2CAA0C;EAC1C,aAAY;EACZ,cAAa;EACb,oBAAmB;EACnB,mBAAkB;EAClB,aAAY,EA2Eb;EAjFD;IASI,qCCnBgC;IDoBhC,gBAAe;IACf,sBAAqB;IACrB,2FAA0F;IAC1F,sFAAqF;IACrF,wFAAuF;IACvF,mFAAkF;IAClF,8BAA6B;IAC7B,qCAAoC;IACpC,mBAAkB;IAClB,mBAAkB,EACnB;EApBH;IAuBM,iBAAgB;IAChB,yBAAwB;IACxB,QAAO;IACP,mBAAkB;IAClB,8CAA6C;IAC7C,OAAM;IACN,YAAW,EACd;EA9BH;IAiCI,qCC3CgC;ID4ChC,eAAc;IAEd,gBAAe;IACf,sBAAqB;IACrB,oBAAmB;IACnB,4CAA4C,EAC7C;EAxCH;IA2CI,eAAc;IACd,gBAAe;IACf,WAAU;IACV,eAAc,EAEf;EAhDH;IAmDI,eAAc;IACd,gBAAe;IACf,kBAAiB;IACjB,0BAAyB;IACzB,qCAAoC;IACpC,4CAA4C,EAC7C;EAzDH;IA4DI,YAAW;IACX,iBAAgB;IAChB,mBAAkB,EACnB;EA/DH;IAkEI,YAAW;IACX,aAAY;IACZ,iBAAgB;IAChB,kBAAiB,EAClB;EAtEH;IAyEI,iBAAgB;IAChB,iBAAgB,EAKjB;IA/EH;MA6EM,eAAc,EACf;;AAKL;EACE,gBAAe;EACf,sBAAqB;EACrB,iBAAgB,EAQjB;EAXD;IAMI,YAAW;IACX,aAAY;IACZ,wBAAuB;IACvB,YAAW,EACZ;;AAGH;EACE,aAAY,EACb;;AAGD;EACE,eAAc,EACf;;AAED;EACE,cAAa;EACb,cAAa;EACb,eAAc,EAKf;EARD;IAMI,cAAa,EACd;;AAGH;EACE,gBAAe;EACf,wCAAuC;EACvC,aAAY;EACZ,sBAAqB;EACrB,kBAAiB;EACjB,0BAAyB;EACzB,aAAY;EACZ,aAAY;EACZ,qBAAoB;EACpB,gBAAe;EACf,0BAAyB;EACzB,6EAA4E,EAC7E;;AAED;EACE,wBAAuB;EACvB,eAAc;EACd,iBAAgB;EAChB,gBAAe,EAChB;;AAED;EACE,cAAa,EACd;;AAED;EACE,iBAAgB,EAWjB;EAZD;IAII,gBAAe;IACf,eAAc,EACf;EANH;IASI,eAAc;IACd,kBAAiB,EAClB","file":"appStyles.scss","sourcesContent":["@import 'themeColors';\n$theme-font:    verdana, sans-serif;\n\nbody {\n  background-image: url('http://www.jakpost.travel/imgfiles/full/31/315598/pastel-sky-wallpaper.jpg');\n  background-size: cover;\n  font-family: 'Pontano Sans', sans-serif;\n  margin: 0 auto;\n}\n\n.game-container {\n  margin-left: 300px;\n  margin-top: 100px;\n  display: flex;\n}\n\n.instructions {\n  background-color: rgba(173, 216, 230, 0.7);\n  width: 600px;\n  height: 700px;\n  align-items: center;\n  text-align: center;\n  color: white;\n\n  h3 {\n    font-family: $title-font;\n    font-size: 45px;\n    letter-spacing: .07em;\n    background: -webkit-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: -o-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: -moz-linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    background: linear-gradient(to right, #ddb03e, #4bda67, #32d0d0, #9f9ff3, #e165e1);\n    -webkit-background-clip: text;\n    -webkit-text-fill-color: transparent;\n    margin-bottom: 0px;\n    position: relative;\n  }\n\n  h3:after {\n      background: none;\n      content: attr(data-text);\n      left: 0;\n      position: absolute;\n      text-shadow: 3px 2px 10px rgba(0, 0, 0, 0.33);\n      top: 0;\n      z-index: -1;\n  }\n\n  h4 {\n    font-family: $title-font;\n    color: #e165e1;\n    // color: #e581ff;\n    font-size: 22px;\n    letter-spacing: 0.3em;\n    margin-bottom: 12px;\n    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.20);\n  }\n\n  p {\n    color: #966ff5;\n    font-size: 16px;\n    width: 90%;\n    margin: 0 auto;\n\n  }\n  \n  span {\n    color: #8369c2;\n    font-size: 18px;\n    font-weight: bold;\n    text-transform: uppercase;\n    font-family: \"Luckiest Guy\", cursive;\n    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.20);\n  }\n\n  img {\n    width: 30px;\n    margin-left: 10%;\n    margin-right: 10px;\n  }\n\n  #white-cloud {\n    width: 40px;\n    height: 40px;\n    margin-left: 10%;\n    margin-right: 0px;\n  }\n\n  ul {\n    list-style: none;\n    text-align: left;\n\n    li {\n      color: #966ff5;\n    }\n  }\n\n}\n\n.arrows {\n  font-size: 30px;\n  display: inline-block;\n  margin: 0px 20px;\n\n  .fab {\n    width: 40px;\n    height: 40px;\n    background-color: black;\n    color: blue;\n  }\n}\n\n#press-start {\n  color: white;\n}\n\n\n#canvas {\n  margin: 0 auto;\n}\n\n.canvas-container {\n  width: 1000px;\n  height: 700px;\n  margin: 0 auto;\n\n  img {\n    display: none;\n  }\n}\n\n#start-btn {\n  font-size: 35px;\n  font-family: 'Luckiest Guy', sans-serif;\n  color: white;\n  letter-spacing: .07em;\n  padding-top: 10px;\n  text-transform: uppercase;\n  width: 150px;\n  height: 70px;\n  border-radius: 200px;\n  border: #e165e1;\n  background-color: #e165e1;\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);\n}\n\n#start-btn:hover {\n  background-color: white;\n  color: #e165e1;\n  transition: 0.2s;\n  cursor: pointer;\n}\n\n.hidden-div {\n  display: none;\n}\n\n.developer-icons {\n  margin-top: 30px;\n  \n  i {\n    font-size: 35px;\n    color: #9d7ced;\n  }\n\n  i:hover {\n    color: #8c55d4;\n    transition: 0.3ms;\n  }\n}","\n// $themeColor-Light: #f3e2c7;\n// $themeColor-Dark: #b68d4c;\n\n// $theme-font: 'Luckiest Guy', cursive;\n$theme-font: 'Pontano Sans', sans-serif; \n$title-font: 'Luckiest Guy', cursive;"],"sourceRoot":""}]);
